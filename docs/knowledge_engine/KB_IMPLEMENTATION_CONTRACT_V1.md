...
### KB_CANONICAL_v1.3.4.md — appliquer le changement

| Changement | Remplace |
|-----------|----------|
| C-18 — `taper_duration_weeks` 3 → 2 | §4.2 v1.2 (table `thresholds.yaml`) + §3.99 RULE-021 |

### KB_CANONICAL_v1.3.5.md — appliquer la nouvelle règle
